...
function CheckAwsReservedInstance() {
    ...
    var result = new app_1.default(new ec2Service_1.default(region), new reservedInstanceCalculator_1.default(), new slackHelper_1.default(region, webhookUrl, channel)).Run();
    return result;
}
