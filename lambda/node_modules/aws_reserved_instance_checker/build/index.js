...
function CheckAwsReservedInstance() {
    ...
    var excludePattern = process.env.RICHECKER_EXCLUDE_PATTERN;
    if (!webhookUrl) {
    ...
    ], new reservedInstanceCalculator_1.default(), new slackHelper_1.default(region, webhookUrl, channel), excludePattern).Run();
    return result;
}
